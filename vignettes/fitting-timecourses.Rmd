...
To have data to work with, 20 timecourses are randomly generated which include a mixture of sigmoid (single response) and impulse (double sigmoid) curves with associated timing, assmptote and rate (steepness) parameters.

```{r simulate_timecourses, fig.height = 10, fig.width = 10}
set.seed(1)
timecourses <- simulate_timecourses(n = 6)
